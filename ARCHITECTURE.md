...
- **M4 (Toy problem 4):**: Nested blueprints using composite (static):
  - Implement static nested blueprint
  - Inputs and Outputs of nested blueprint
  - Flattening of nested blueprint
